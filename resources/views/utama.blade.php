    ...
    <div class="container-fluid mb-5" style="background-color: #CBDCEB; padding : 10px; border-radius: 20px">
        <div class="row pt-5 mb-5 mx-auto justify-content-evenly" style="background-color: #F3F3E0; padding : 10px; border-radius: 20px; max-width: 95%">
            ...
            <div class="card-body" style="color: #133E87;">
                ...
                <br>
                <p>
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aspernatur iure obcaecati voluptatum quisquam recusandae eos fugit omnis?
                    Aliquam, mollitia. Corporis voluptates impedit voluptatibus blanditiis doloremque perferendis? Dicta quas laudantium earum, 
                    soluta rerum tempora eaque! 
                    Neque quos soluta magnam distinctio iure sed dignissimos quam labore, sunt, explicabo provident! Omnis, repellat sequi.
                </p>
